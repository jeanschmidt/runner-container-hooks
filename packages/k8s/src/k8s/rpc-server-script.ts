// Auto-generated RPC server script — do not edit directly.
// Edit the Python source and re-embed.
export const RPC_SERVER_SCRIPT = `#!/usr/bin/env python3
import argparse
import json
import os
import signal
...
def _start_exec(job_id, script_path):
    ...
    logfile = open(os.path.join(LOG_DIR, f"{job_id}.log"), "wb")
